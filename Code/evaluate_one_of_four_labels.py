...
if __name__ == "__main__":
    ...
    EVALUATION_RESULT_KEY = "evaluation_of_assigned_one_of_four_label"
    ...
    for project, issue_reports in data.items():
        ...
        for i in range(len(issue_reports)):
            ...
            if cur_issue_report > 0:
                ...
                prompt += "'''title''': '''" + title + "'''\n'''body''': '''" + body + "'''\n\n"
                prompt += "The following were the patches that resolve this issue: \n\n"
                ...
                label = issue_reports[i][LABELS_TO_EVALUATE_KEY]
